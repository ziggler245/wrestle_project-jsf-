 ...
 */
@ManagedBean(eager=true,name="battleground")
@RequestScoped
public class Battleground implements Serializable{
    ...
    public static void getBattlegroundPlan(){
         ...
         ppvPlan=new ArrayList();
            ...
            if (connection == null)
            {
                throw new SQLException("Error establishing connection!");
                 ...
                 query="SELECT *  FROM ppvs_seats where name=\"Battleground\"";
             ...
             query = "SELECT * from ppv_shows where name=\"Battleground\" group by seat ";
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){
 ...
 hallPlan.add(hp);
             ...
             query = "SELECT * from ppv_shows where name=\"Battleground\" and seat="+i;
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){

 ...
 */
@ManagedBean(eager=true,name="erules")
@RequestScoped
public class ExtremeRules implements Serializable{
    ...
    public static void getExtremeRulesPlan(){
         ...
         ppvPlan=new ArrayList();
            ...
            if (connection == null)
            {
                throw new SQLException("Error establishing connection!");
                 ...
                 query="SELECT *  FROM ppvs_seats where name=\"Extreme Rules\"";
             ...
             query = "SELECT * from ppv_shows where name=\"Extreme Rules\" group by seat ";
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){
 ...
 hallPlan.add(hp);
             ...
             query = "SELECT * from ppv_shows where name=\"Extreme Rules\" and seat="+i;
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){
            ...
            Logger.getLogger(ExtremeRules.class.getName()).log(Level.SEVERE, null, ex);
        }finally {
            try {
                if (statement != null) {
                    statement.close();

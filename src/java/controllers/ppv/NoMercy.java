 ...
 */
@ManagedBean(eager=true,name="nomercy")
@RequestScoped
public class NoMercy implements Serializable{
    ...
    public static void getNoMercyPlan(){
         ...
         ppvPlan=new ArrayList();
            ...
            if (connection == null)
            {
                throw new SQLException("Error establishing connection!");
                 ...
                 query="SELECT *  FROM ppvs_seats where name=\"No Mercy\"";
             ...
             query = "SELECT * from ppv_shows where name=\"No Mercy\" group by seat ";
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){
 ...
 hallPlan.add(hp);
             ...
             query = "SELECT * from ppv_shows where name=\"No Mercy\" and seat="+i;
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){
            ...
            Logger.getLogger(NoMercy.class.getName()).log(Level.SEVERE, null, ex);
        }finally {
            try {
                if (statement != null) {
                    statement.close();

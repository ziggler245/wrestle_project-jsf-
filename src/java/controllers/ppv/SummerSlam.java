 ...
 */
@ManagedBean(eager=true,name="sslam")
@RequestScoped
public class SummerSlam implements Serializable{
    ...
    public static void getSummerSlamPlan(){
         ...
         ppvPlan=new ArrayList();
            ...
            if (connection == null)
            {
                throw new SQLException("Error establishing connection!");
                 ...
                 query="SELECT *  FROM ppvs_seats where name=\"SummerSlam\"";
             ...
             query = "SELECT * from ppv_shows where name=\"SummerSlam\" group by seat ";
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){
 ...
 hallPlan.add(hp);
             ...
             query = "SELECT * from ppv_shows where name=\"SummerSlam\" and seat="+i;
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){
            ...
            Logger.getLogger(SummerSlam.class.getName()).log(Level.SEVERE, null, ex);
        }finally {
            try {
                if (statement != null) {
                    statement.close();

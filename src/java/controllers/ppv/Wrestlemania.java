 ...
 */
@ManagedBean(eager=true,name="mania")
@RequestScoped
public class Wrestlemania implements Serializable{
    ...
    public static void getWrestlemanisPlan(){
         ...
         ppvPlan=new ArrayList();
            ...
            if (connection == null)
            {
                throw new SQLException("Error establishing connection!");
                 ...
                 query="SELECT *  FROM ppvs_seats where name=\"Wrestlemania\"";
             ...
             query = "SELECT * from ppv_shows where name=\"Wrestlemania\" group by seat ";
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){
 ...
 hallPlan.add(hp);
              ...
              query = "SELECT * from ppv_shows where name=\"Wrestlemania\" and seat="+i;
             statement = connection.prepareStatement(query);
             rs = statement.executeQuery();
             while(rs.next()){
            ...
            Logger.getLogger(Wrestlemania.class.getName()).log(Level.SEVERE, null, ex);
        }finally {
            try {
                if (statement != null) {
                    statement.close();
